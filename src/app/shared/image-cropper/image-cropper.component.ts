...
export class ImageCropperComponent
  ...
  public onTouchStart(event: TouchEvent): void {
    this.dragUnsubscribers.push(this.renderer.listen(this.document, 'touchmove', this.onTouchMove.bind(this)));
    this.dragUnsubscribers.push(this.renderer.listen(this.document, 'touchend', this.onTouchEnd.bind(this)));
